...
@endphp
<!-- blog section start -->
<section class="pb-180 {{ (request()->route()->getName() != 'home' && request()->route()->getName() != 'tournament') ? 'pt-180':'' }}" style="background-image: url('/assets/images/frontend/blog/back.jpg'); background-repeat: repeat; background-size: contain">
    <div class="container">
