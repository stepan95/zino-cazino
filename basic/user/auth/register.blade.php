...
@section('content')
    ...
    <section class="registration-section bg_img" style="background-image: url( {{ getImage('assets/images/frontend/register/' . @$registerContent->data_values->image, '1920x960') }} );">
        <div class="registration-area not-lab">
            <div class="registration-area-inner">
                <div class="text-center">
                    ...
                    <p>Register and get <span class="border-span">10$ welcome bonus!</span> {{--{{ __(@$registerContent->data_values->sub_title) }}--}}</p>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div class="input-group ">
                                ...
                                <a href="#" class="password-confirm-control"></a>
                            </div>
                        </div><!-- form-group end -->

						<div class="form-group hover-input-popup col-md-12">
                            <label for="password">@lang('Promo code')</label>
                            <div class="input-group ">
                                <div class="input-group-prepend">
                                    <div class="input-group-text"><i class="las la-key"></i></div>
                                </div>
                                <input id="promocode" type="text" class="form-control" name="promocode" value="{{ old('promocode') }}">
                            </div>
                            @if($general->secure_password)
                                <div class="input-popup">
                                    <p class="error lower">@lang('1 small letter minimum')</p>
                        ...
                        @if($general->agree)
                            ...
                            @endphp
                            <div class="form-group agree-lab col-md-12 d-flex align-items-start">
                        ...
                        <div class="mt-3 text-center col-md-12 but-flx">
                            <button type="submit" class="cmn-btn rounded-0">@lang('Register')</button>
                            <span class="mt-20">@lang('Already i have an account in here')</span>
    ...
    <script>
      "use strict";
        ...
        (function ($) {
            ...
            $('body').on('click', '.password-confirm-control', function(){
