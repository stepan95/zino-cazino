                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <div class="withdraw-details">
                                    ...
                                    <span class="font-weight-bold pull-right">  {{ rtrim($withdraw->rate, 0) }} {{__($withdraw->currency)}}</span>
                                </div>
                                @endif
                                <div class="withdraw-details text-success">
                                    <span class="font-weight-bold">@lang('You Will Get') :</span>
                                    <span class="font-weight-bold pull-right">{{rtrim($withdraw->final_amount, 0) }} {{__($withdraw->currency)}}</span>
                                </div>
