        ...
        <div class="contact-wrapper">
            <div class="row">
                ...
                <div class="col-lg-6 contact-form-wrapper">
                    ...
                    <form class="contact-form mt-4" method="post" action="" id="zinoform">
                        @csrf
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-lg-12">
                                <button type="submit" class="cmn-btn" class="g-recaptcha" data-sitekey="{{ env('RECAPTCHA_SECRET_KEY') }}" data-callback='onSubmit' data-action='submit'>@lang('Send Message')</button>
                            </div>
