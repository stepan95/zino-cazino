...
<head>
    ...
    <link rel="stylesheet" href="/{{$activeTemplateTrue}}css/main.css">
...
<div class="page-wrapper" id="main-scrollbar" data-scrollbar>
    ...
    <header class="new_header header menu-sticky" >
    ...
    <!--breadcrumb area-->
@if(request()->route()->getName() != 'tournament.single' AND request()->route()->getName() != 'home' AND request()->route()->getName() != 'zinocoins' AND request()->route()->getName() != 'about' AND request()->route()->getName() != 'lottery' AND request()->route()->getName() != 'sport' AND request()->route()->getName() != 'tournament')
...
<script src="/assets/counter/js/jquery.flipTimer.js"></script>
