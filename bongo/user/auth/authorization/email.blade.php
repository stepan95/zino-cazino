...
<div class="modal fade email_verify" id="withdrawError" tabindex="-1" role="dialog" aria-labelledby="withdrawErrorLabel" aria-hidden="true" data-bs-keyboard="false" data-bs-backdrop="static"> 
    <div class="modal-dialog modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <div class="verify_popup_title" id="exampleModalLabel">
                    @lang('Please Verify Your Email to') <span>@lang('Get Access')</span>
                </div>
            </div>
            <div style="color: #ffffff; border: none; padding-top: 7px;" class="modal-body">
                <form action="{{route('user.verify.email')}}" method="POST" class="login-form">
                            ...
                            <p style="font-size: 14px;">@lang('Please check including your Junk/Spam Folder. if not found, you can') <a
                                    ...
                                    class="forget-pass main_btn_green"> @lang('Resend code')</a></p>
        ...
        <div class="profile_games_container">
            <div class="profile_games_top">
                ...
                <p class="profile_games_description">
                    @lang('profile_games_description')
                </p>
            </div>
    ...
    <div class="modal-dialog" role="document" style="width: 99%; max-width: 95%; margin-top: 0; margin-bottom: 0;">
        <div class="modal-content section--bg" style="background-color: #000;">
            ...
            <div id="fullscreen">
                ...
                <div style="text-align: right;"><a href="#" class="requestfullscreen" style="color: white;">@lang('Click to open it in fullscreen')</a><a href="#" class="exitfullscreen" style="display: none; color: white; margin-right: 20px;">Click to exit fullscreen</a></div>
            </div>
