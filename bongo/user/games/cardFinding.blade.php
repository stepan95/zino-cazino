                        ...
                        <form method="post" id="game">
                            ...
                            <div class="form-group mt-5 justify-content-center d-flex">
                                <div class="single-select red">
                                    <img  loading="lazy"   src="{{ asset($activeTemplateTrue.'images/play/cards/27.png') }}" class="red"
                                         alt="">
                                </div>
                                <div class="single-select black">
                                    <img  loading="lazy"   src="{{ asset($activeTemplateTrue.'images/play/cards/40.png') }}" class="black"
                                         alt="">
                                </div>
                            </div>
