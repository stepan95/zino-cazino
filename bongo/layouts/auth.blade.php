...
{{--<div class="preloader">
    <div class="preloader__inner">
        <div class="preloader__thumb">
            <img  loading="lazy"   src="/assets/images/logoIcon/logo.png" alt="imge" class="mt-3 loaderLogo">
            <img  loading="lazy"   src="/{{$activeTemplateTrue}}/images/preloader-dice.png" alt="image" class="loadercircle">
        </div>
    </div>
</div>--}}
...
<div class='loader'>
    <div class='loader-container'>
        <img  loading="lazy"   style="margin-bottom: 35px" src="/assets/assets/images/logoIcon/preloader_img.png" alt=""/>
...
<div class="page-wrapper" id="main-scrollbar" data-scrollbar>
    <div class="logo_auth">
        <a href="/"><img loading="lazy" src="https://dev.zino-game.com/assets/images/logoIcon/bongo_logo.png" alt="Bongo"></a>
    </div>
