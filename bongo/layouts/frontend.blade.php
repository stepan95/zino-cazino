...
<head>
    ...
    <!-- bootstrap 4  -->
    <link rel="stylesheet" href="/{{$activeTemplateTrue}}css/reset.css">
    <link rel="stylesheet" href="/{{$activeTemplateTrue}}css/minstyle.css">
...
<?php if(0) { ?>
    ...
    <script>
        ...
        })(window, document, 'script', 'dataLayer', 'GTM-TTCNM4F');
    </script>
...
<?php if(0) { ?>
    ...
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-TTCNM4F" height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
    <!-- End Google Tag Manager (noscript) -->
<?php } ?> 
    <div class='loader'>
        <div class='loader-container'>
            <img  style="margin-bottom: 35px"  data-original="/assets/assets/images/logoIcon/preloader_img.png" alt="" />
            ...
            <div class="header__container">
                <div class="header_wrapper">
                    ...
                    <div class="header_left">
                        <div class="header_left_item header_left_item_user  header_btn_profile_desctop">
                            ...
                            <img   data-original="{{ asset('/assets/images/header_images/settings_icone.png') }}">
                            <div class="menu-drop">
                        ...
                        <div class="header_left_item header_left_user_btn header_left_item_user header_btn_profile_mobile">
                            <img   data-original="https://dev.zino-game.com/assets/images/header_images/settings_icone.png">
                        </div>
                        <?php
                        ...
                        <div class="header_left_item header_left_item_not ">
                            <button type="button" class="primary--layer" data-toggle="dropdown" data-display="static" aria-haspopup="true" aria-expanded="false" style="background-color: transparent;">
                                <img   data-original="{{ asset('/assets/images/header_images/notification_icone.png') }}">
                            </button>
                ...
                <div class="header_right">
                    <div class="header_right_item">
                        Balance:
                        <span>{{ getAmount(auth()->user()->getBalance(1)) }} {{ $general->cur_text }}</span>
                    </div>
                    <div class="header_right_item">
                        Money:
                        <span>{{ getAmount(auth()->user()->getMoney(1)) }} {{ $general->cur_text }}</span>
                    </div>
                    <div class="header_right_item">
                        Bonus:
                        <span>{{ getAmount(auth()->user()->getBonus(1)) }} {{ $general->cur_text }}</span>
                    </div>
                    <div class="header_right_item">
                        Level:
                        <span>
                            @if(auth()->user()->level != 0)
                            <img   data-original="{{ auth()->user()->getBonusLevelImage() }}" alt="zinocoin" class="balance_right_image">
                            @endif
                ...
                <div class="header_mobile_menu">
                    <div class="header_mobile_menu_wrapper">
                        @auth
                        <a href="{{ route('user.deposit') }}" class="header_mobile_btn main_btn_green">Deposit</a>
                        @else 
                        ...
                        <ul class="site_bar_nav">
                            ...
                            <li class="site_bar_nav_item {{ request()->is('blog') ? 'active':'' }}" title="Suport 24/7"><a href="https://t.me/+-yvMy2qDtJk1NDAy" target="_blank">
                                ...
                                </svg><span>Suport 24/7</span> </a></li>
                        </ul>
                        @auth
                        <a href="{{ route('user.withdraw') }}" class="header_mobile_btn main_btn">Withdraw</a>
                        @else 
                ...
                <div class="header_user_menu">
                    <div class="header_user_menu_wrapper">
                        ...
                        <a href="{{ route('user.home') }}" class="header_mobile_btn main_btn_green">Dashboard</a> 
                        <a href="{{ route('user.deposit') }}" class="header_mobile_btn main_btn_green">deposit</a>
                        <a href="{{ route('user.withdraw') }}" class="header_mobile_btn main_btn">windraw</a>
                        <ul class="header_user_menu_list">
                            <li class="header_user_menu_list_item"><a href="{{ route('user.referrals') }}">referrals</a></li>
                            <li class="header_user_menu_list_item"><a href="#">reports</a></li>
                            <li class="header_user_menu_list_item"><a href="#">support</a></li>
                            <li class="header_user_menu_list_item"><a href="#">account</a></li>
                            <li class="header_user_menu_list_item"><a href="{{ route('user.logout') }}">logout</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="header__container">
                      <div class="header_wrapper">
                        <div class="header_left_mobile">
                          ...
                          <div class="site_bar_logo">
                            <img  data-original="{{ asset('assets/images/logoIcon/bongo_logo.png') }}" alt="Bongo">
                          </div>
                        </div>
                        <div class="header_right">
             ...
             <div class="site_bar">
                <div class="site_bar_container">
                    <div class="site_bar_top">
                        <div class="site_bar_logo">
                            <a href="{{ route('home') }}"><img   data-original="{{ asset('assets/images/logoIcon/bongo_logo.png') }}" alt="Bongo" ></a>
                        </div>
                    ...
                    <div class="site_bar_bottom">
                        @auth
                        <a href="{{ route('user.deposit') }}" class="site_bar_btn main_btn_green">Deposit</a>
                        <a href="{{ route('user.withdraw') }}" class="site_bar_btn main_btn">Withdraw</a>
                        @else 
    ...
    <!--breadcrumb area-->
    @if(request()->route()->getName() != 'tournament.single' AND request()->route()->getName() != 'home' AND request()->route()->getName() != 'bongocoins' AND request()->route()->getName() != 'about' AND request()->route()->getName() != 'lottery' AND request()->route()->getName() != 'sport' AND request()->route()->getName() != 'tournament')
        ...
        <div class="crypto__container">
          <div class="crypto_wrapper">
            <div class="crypto_img">
              <picture>
                <source srcset="{{ getImage('assets/images/profile/crypto_payments_bongo_mobile.png') }}" media="(max-width: 764.98px)">
                <img   data-original="{{ getImage('assets/images/profile/crypto_payments_bongo.png') }}" alt="" class="crypto_img">
              </picture>
    ...
    <footer class="footer">
        <div class="footer__container">
            ...
            <div class="footer_top">
              <div class="footer_top_logo">
                ...
                <div class="footer_top_descr">
                  All rights & Copy right reserved by Bongo.land
                </div>
              </div>
          ...
          <div class="footer_copy">
            <p> Copyright © 2023 <a href="https://bongo.land">bongo.land</a> is owned and operated by Algo Group is incorporated under the laws of Curacao with company registration number 157136 and having its registered address at Scharlooweg 27, Willemstad, Curaçao. Algo Group is operating under E-gaming licenses of Curacao(8048/JAZ2020-17).</p>
        </div>
        </div>
      </footer>
      <!-- Footer END -->
        ...
        <div class="mobile__container">
          <div class="mobile__wrapper">
          	<ul class="mobile_list " >
                <li class="active"><a href="/user/dashboard"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.0" width="18px" height="18px" viewBox="0 0 64 64" enable-background="new 0 0 64 64" xml:space="preserve">
                    <path fill="none" d="M62.799,23.737c-0.47-1.399-1.681-2.419-3.139-2.642l-16.969-2.593L35.069,2.265  C34.419,0.881,33.03,0,31.504,0c-1.527,0-2.915,0.881-3.565,2.265l-7.623,16.238L3.347,21.096c-1.458,0.223-2.669,1.242-3.138,2.642  c-0.469,1.4-0.115,2.942,0.916,4l12.392,12.707l-2.935,17.977c-0.242,1.488,0.389,2.984,1.62,3.854  c1.23,0.87,2.854,0.958,4.177,0.228l15.126-8.365l15.126,8.365c0.597,0.33,1.254,0.492,1.908,0.492c0.796,0,1.592-0.242,2.269-0.72  c1.231-0.869,1.861-2.365,1.619-3.854l-2.935-17.977l12.393-12.707C62.914,26.68,63.268,25.138,62.799,23.737z"/>
                    </svg> @lang('Extra')</a></li>
                <li class="active"><a href="/user/games/slots">
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="none" width="20px" height="20px" version="1.1" viewBox="0 0 31.985 31.969" xml:space="preserve">
                    <g id="ace">
                        <path d="M11.939,6c0,0-5.275,2.729-6.636,6.834c-0.693,2.455-0.064,3.951,0.563,4.76c0.75,0.971,1.979,1.549,3.288,1.549   c0.635,0,1.243-0.195,1.779-0.498l-0.314,2.777c-0.021,0.131,0.02,0.293,0.109,0.393c0.087,0.1,0.217,0.186,0.352,0.186h1.95   c0.135,0,0.264-0.086,0.352-0.186c0.089-0.1,0.129-0.247,0.109-0.378l-0.299-2.681c0.518,0.244,1.088,0.391,1.647,0.391   c1.308,0,2.538-0.581,3.289-1.552c0.626-0.807,1.255-2.306,0.562-4.761C17.333,8.729,11.939,6,11.939,6z"/>
                        <path d="M30.559,4.104L24,2.14V2c0-1.104-0.896-2-2-2H2C0.896,0,0,0.896,0,2v25c0,1.104,0.896,2,2,2h10.611l9.627,2.884   c1.058,0.317,2.173-0.284,2.489-1.342l7.174-23.948C32.218,5.536,31.616,4.421,30.559,4.104z M2,2h20v25H2V2z"/>
                ...
                <li class="active"><a href="/">
                    ...
                    @lang('HOME')</a></li>
                <li class="active"><a href="/user/games/live">
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"width="20px" height="20px" version="1.1" id="Icons" viewBox="0 0 32 32" xml:space="preserve">
                        <path d="M26.6,5.4C26.6,5.4,26.6,5.4,26.6,5.4C26.6,5.4,26.6,5.4,26.6,5.4C23.9,2.7,20.1,1,16,1S8.1,2.7,5.4,5.4c0,0,0,0,0,0  s0,0,0,0C2.7,8.1,1,11.9,1,16s1.7,7.9,4.4,10.6c0,0,0,0,0,0s0,0,0,0C8.1,29.3,11.9,31,16,31s7.9-1.7,10.6-4.4c0,0,0,0,0,0s0,0,0,0  C29.3,23.9,31,20.1,31,16S29.3,8.1,26.6,5.4z M25.9,7.6c1.7,2,2.9,4.6,3.1,7.4h-2c-0.2-2.3-1.1-4.4-2.5-6L25.9,7.6z M15,3.1v2  c-2.3,0.2-4.4,1.1-6,2.5L7.6,6.1C9.6,4.4,12.2,3.3,15,3.1z M6.1,24.4c-1.7-2-2.9-4.6-3.1-7.4h2c0.2,2.3,1.1,4.4,2.5,6L6.1,24.4z   M5.1,15h-2c0.2-2.8,1.3-5.4,3.1-7.4L7.6,9C6.2,10.6,5.3,12.7,5.1,15z M15,28.9c-2.8-0.2-5.4-1.3-7.4-3.1L9,24.4  c1.7,1.4,3.8,2.3,6,2.5V28.9z M16,22c-0.3,0-0.6-0.1-0.8-0.4l-4-5c-0.3-0.4-0.3-0.9,0-1.2l4-5c0.4-0.5,1.2-0.5,1.6,0l4,5  c0.3,0.4,0.3,0.9,0,1.2l-4,5C16.6,21.9,16.3,22,16,22z M17,28.9v-2c2.3-0.2,4.4-1.1,6-2.5l1.4,1.4C22.4,27.6,19.8,28.7,17,28.9z   M23,7.6c-1.7-1.4-3.8-2.3-6-2.5v-2c2.8,0.2,5.4,1.3,7.4,3.1L23,7.6z M25.9,24.4L24.4,23c1.4-1.7,2.3-3.8,2.5-6h2  C28.7,19.8,27.6,22.4,25.9,24.4z"/>
                        </svg> @lang('live')</a></li>
                <li class="active"><a href="/promo">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" viewBox="0 0 1024 1024"><path fill="none" d="M640 832H64V640a128 128 0 1 0 0-256V192h576v160h64V192h256v192a128 128 0 1 0 0 256v192H704V672h-64v160zm0-416v192h64V416h-64z"/></svg>
                    @lang('Promo')</a></li>
          	</ul>
          </div>
    ...
    //print_r($cookie->data_values->status);
    @endphp
    ...
    <!-- slider custom js -->
    <script src="/{{$activeTemplateTrue}}js/owl.carousel.min.js"></script>
    <script async src="/{{$activeTemplateTrue}}js/jquery.fullscreen.min.js"></script>
    <script src="/assets/global/js/choices.min.js?1.4"></script>
    <script src="/assets/global/js/script.js?1.9"></script>
    <script async src="/assets/counter/js/jquery.flipTimer.js"></script>
    ...
    <script>
        (function($) {
            ...
            var height = $(".owl-carousel1 .hero.bg_img > .container-fully").height();
            console.log(height);
            $('.owl-carousel1 section .container').each(function() {
                $(this).css('height', height);
            });
            var height = $(".owl-carousel2 .pt-120.pb-120 > .container-fully").height();
            console.log(height);
            $('.owl-carousel2 section .container').each(function() {
                $(this).css('height', height);
            });
            var height = $(".owl-carousel1 .owl-item.active").height();
            console.log(height);
            $('.owl-carousel1').css('height', height);
            var height = $(".owl-carousel2 .owl-item.active").height();
            console.log(height);
            $('.owl-carousel2').css('height', height);

            var height = $(".owl-carousel11 .hero.bg_img > .container-fully").height();
            console.log(height);
            $('.owl-carousel11 section .container').each(function() {
                $(this).css('height', height);
            });
            var height = $(".owl-carousel22 .pt-120.pb-120 > .container-fully").height();
            console.log(height);
            $('.owl-carousel22 section .container').each(function() {
                $(this).css('height', height);
            });
            var height = $(".owl-carousel11 .owl-item.active").height();
            console.log(height);
            $('.owl-carousel11').css('height', height);
            var height = $(".owl-carousel22 .owl-item.active").height();
            console.log(height);
            $('.owl-carousel22').css('height', height);
            ...
            if (isset($tours)) {
                foreach ($tours as $val) {
                    if ($val->begin_at < date('Y-m-d') && date('Y-m-d') < $val->end_at) { ?>
                        $('.flipTimer{{ $val->alias }}').flipTimer({

                            // count up or countdown
                            direction: 'down',

                            // the target <a href="https://www.jqueryscript.net/time-clock/">date</a>
                            date: '{{ $val->end_at }} 00:00:00'
                        });
                    <?php } else { ?>
                        ...
                        $('.flipTimer{{ $val->alias }}').flipTimer({
                            ...
                            // the target <a href="https://www.jqueryscript.net/time-clock/">date</a>
                            date: '{{ $val->begin_at }} 00:00:00'
                        });
            <?php }
                }
            } ?>
            <?php if (isset($tour->begin_at)) {
                if ($tour->begin_at < date('Y-m-d') && date('Y-m-d') < $tour->end_at) { ?>

                    $('.flipTimerOne').flipTimer({

                        // count up or countdown
                        direction: 'down',

                        // the target <a href="https://www.jqueryscript.net/time-clock/">date</a>
                        date: '{{ $tour->end_at }} 00:00:00'
                    });
                <?php } elseif (date('Y-m-d') > $tour->end_at) { ?>
                    $('.flipTimerOne').flipTimer({
    ...
    <link rel="stylesheet" href="/{{$activeTemplateTrue}}css/style.css">
    ...
    <link rel="stylesheet" href="/assets/global/css/stylepages.css">
    ...
    <link rel="stylesheet" href="/{{$activeTemplateTrue}}css/color.php?color='.$general->base_color">
	<link rel="stylesheet" href="/assets/global/css/maindash.css">
	<link rel="stylesheet" href="/assets/global/css/choices.min.css">
    <link rel="stylesheet" href="/assets/global/css/owl.carousel.min.css">
    <link rel="stylesheet" href="/assets/global/css/owl.theme.default.min.css">
    <link href="/assets/counter/css/flipTimer.css" rel="stylesheet">
    @stack('style')
    @stack('style-lib')
</body>
