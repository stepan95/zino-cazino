...
@push('style')
    <link rel="stylesheet" href="/assets/templates/bongo/css/components/Blog/single_blog.css">
@endpush
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="blog-details-wrapper">
                    ...
                    <div class="post-details-thumb"><img class="w-100" src="{{ getImage('assets/images/frontend/blog/' . @$blog->data_values->blog_image, '670x375') }}" alt="image" loading="lazy"></div>
