...
<section class="pt-120 pb-120 referral" style="background-image: url( {{ getImage('assets/images/frontend/referral/'.@$referralContent->data_values->background_image,'1920x780') }} );">
    <div class="container">
        <div class="row justify-content-between align-items-center">
            ...
            <div class="col-lg-7 mt-lg-0 mt-5 wow fadeInRight" data-wow-duration="0.5s" data-wow-delay="0.5s">
                <div class="referral-content referal_description">
